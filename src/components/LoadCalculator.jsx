...
export default function LoadCalculator() {
  ...
  const computeWind = () => {
    ...
    return { V, Kz, qz: r2(qz, 1), p_windward: r2(windDesignPressure(qz, GUST_FACTOR, 0.80, qz, 0.18), 1), p_leeward: r2(windDesignPressure(qz, GUST_FACTOR, -0.50, qz, 0.18), 1), p_side: r2(windDesignPressure(qz, GUST_FACTOR, -0.70, qz, 0.18), 1), height: buildingHeight_m };
  };
  ...
  const computeSeismic = () => {
    ...
    const bs = seismicBaseShear(params.SDS, params.SD1, loads.rFactor, loads.importanceFactor, buildingWeight_kN, T);
    return { region, Fa, Fv, ...params, hn, T: r2(T, 3), ...bs };
  };
        ...
        {showSeismicCalc && (
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <div className="input-group"><label>Site Class</label>
              ...
              <div className="input-group"><label>Response Mod (R)</label>
              ...
              <div className="input-group"><label>Building W (kN)</label>
